...
class linear_layer:
    ...
    def __init__(self, input_D, output_D):
        ...
        mean = 0
        deviation = 0.1
        self.params['W'] = np.random.normal(mean, deviation, (input_D, output_D))
        self.params['b'] = np.random.normal(mean, deviation, (1, output_D))
    ...
    def forward(self, X):
        ...
        # print("linear input shape: " + str(X.shape))
        # print("output shape: " + str(forward_output.shape))
    ...
    def backward(self, X, grad):
        ...
        #################################################################################################
        output_D = grad.shape[1]
        backward_output = np.dot(grad, self.params['W'].T)
        self.gradient['W'] = np.dot(X.T, grad)
        self.gradient['b'] = np.sum(grad, 0)
        # print("linear backward b shape: " + str(self.gradient['b'].shape))
        #
        # print("grad shape: " + str(grad.shape))
        # print("W shape: " + str(self.params['W'].T.shape))
        # print("output shape: " + str(backward_output.shape))
...
class relu:
    ...
    def forward(self, X):
        ...
        # print("relu input shape: " + str(X.shape))
        # print("output shape: " + str(forward_output.shape))
    ...
    def backward(self, X, grad):
        ...
        backward_output = np.multiply(mask, grad)
...
class tanh:
    ...
    def forward(self, X):
        ...
        # print("tanh input shape: " + str(X.shape))
        # print("output shape: " + str(forward_output.shape))
    ...
    def backward(self, X, grad):
        ...
        backward_output = np.multiply(grad, derivative)
        # print(np.power(np.tanh(X), 2))
        # print(derivative)
...
class dropout:
    ...
    def forward(self, X, is_train):
        ...
        # print("dropout input shape: " + str(X.shape))
        # print("output shape: " + str(forward_output.shape))
